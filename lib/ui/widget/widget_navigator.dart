...
class CustomRouteObserver<R extends Route<dynamic>> extends RouteObserver<R> {
  final String TAG = "CustomRouteObserver";

  @override
  void didPush(Route route, Route? previousRoute) {
    super.didPush(route, previousRoute);
    print('$TAG didPush route：$route，previousRoute：$previousRoute');
  }

  @override
  void didPop(Route route, Route? previousRoute) {
    super.didPop(route, previousRoute);
    print('$TAG didPop route：$route，previousRoute：$previousRoute');
  }

  @override
  void didReplace({Route? newRoute, Route? oldRoute}) {
    // super.didReplace(newRoute, oldRoute);
    print('$TAG didReplace newRoute：$newRoute，oldRoute：$oldRoute');
  }

  @override
  void didRemove(Route route, Route? previousRoute) {
    super.didRemove(route, previousRoute);
    print('$TAG didRemove route：$route，previousRoute：$previousRoute');
  }

  @override
  void didStartUserGesture(Route route, Route? previousRoute) {
    super.didStartUserGesture(route, previousRoute);
    print('$TAG didStartUserGesture route：$route，previousRoute：$previousRoute');
  }
